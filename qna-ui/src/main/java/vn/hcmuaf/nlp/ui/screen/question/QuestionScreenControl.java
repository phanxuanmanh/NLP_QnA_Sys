...
import vn.hcmuaf.nlp.ui.screen.question.create.CreateQuestionTab;
import vn.hcmuaf.nlp.ui.screen.question.history.ViewOldQuestionTab;
...
public class QuestionScreenControl {
	...
	public QuestionScreenControl(LoginService loginService, QuestionScreen questionScreen) {
	...
	public void initScreen() {
		...
		createQuestionTab = new CreateQuestionTab(this);
		viewOldQuestionTab = new ViewOldQuestionTab(this);
		...
		newQuestionBtn = new Button(MessageUtils.getString("QuestionScreen.control.new-question"));
		oldQuestionBtn = new Button(MessageUtils.getString("QuestionScreen.control.old-question"));
		...
		mainScreenPanel.setContent(createQuestionTab);
	}
