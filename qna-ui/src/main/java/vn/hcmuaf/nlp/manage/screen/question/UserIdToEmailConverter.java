...
public class UserIdToEmailConverter implements Converter<String, Integer> {
	...
	public String convertToPresentation(Integer value, Class<? extends String> targetType, Locale locale)
			throws com.vaadin.data.util.converter.Converter.ConversionException {
		String userEmail = QuestionHistoryServiceProvider.getUserEmailById(value.intValue());
		return userEmail;
	}
