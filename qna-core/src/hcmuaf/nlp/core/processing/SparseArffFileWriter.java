...
public class SparseArffFileWriter {
	 ...
	 */
	public void writeFile(String filename, List<Integer> listKeyWord,
			List<Integer> listQuestion) throws FileNotFoundException {
		...
		PrintWriter pw = new PrintWriter(new File(RESOURCE_FOLDER + filename
				+ FILE_EXTENSION));
		HashMap<Integer, Integer> wordWithOrder = new HashMap<Integer, Integer>();
		...
		// declare class type
		ArrayList<QuestionType> listType = typeDao.getTypeList();
